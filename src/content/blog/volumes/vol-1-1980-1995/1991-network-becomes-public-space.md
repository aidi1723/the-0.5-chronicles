...
它不再只是一个供专业系统调用、供少数机构连接的信息基础设施，
而开始显出“空间”的轮廓——一个可进入、可承载内容、可支持协作的公共空间雏形。

### 一句总结

> **1991 年的关键，是网络开始从工具系统变成公共空间。**

### 为什么这一年重要

这一年的变化，不一定立刻改变普通人的日常，
但它改变了网络未来会成为什么东西。
...
- World Wide Web 开始向更广范围开放
- Linux 的诞生让开放协作成为一种可见的生产方式
- 网络第一次更明显地朝着“承载知识、交流、表达与协作”的方向发展
...
当网络可以不只是传输命令和文件，而能承载页面、链接、结构化内容时，
它就开始从工具走向空间。

#### 2. 开放协作开始显形

Linux 的出现，不只是软件史事件。
它更重要的意义是：它让“很多人跨地域协作完成同一件事”这件事，第一次更明确地显露出来。
