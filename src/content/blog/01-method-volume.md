---
title: "Method Volume: How to Read and Verify This Project / 方法卷：如何使用与验证这套记录"
description: "A practical guide to scope, evidence levels, and the three formats (Yearbook / Tracks / Artifacts). / 范围、证据分级与三种文章类型（年度章/主题线/档案条目）的使用说明。"
pubDate: "Feb 24 2026"
...
### 2) 三种文章类型
- 年度章（Yearbook）：每年一章，写“当年可感知的技术现实”
- 主题线（Tracks）：跨年份串联一条机制（个人计算/网络/软件/制造/贸易/媒体/AI）
- 档案条目（Artifacts）：单个物件/软件/广告/说明书/价格/照片等的硬细节

### 3) 证据分级
- 事实（Fact）：可复查的材料（照片/扫描/链接/型号/版本号/价格/时间点）
- 回忆（Memory）：个人或口述，明确标注，并尽量提供可交叉验证线索
- 推测（Inference）：机制推演，明确标注，不写成既定事实

### 4) 标签体系（建议）
- Track：track-pc / track-network / track-software / track-manufacturing / track-trade / track-media / track-ai
- Format：yearbook / artifact / essay
- Region：china / global
- Domain：hardware / os / programming / education / factory / logistics / finance
